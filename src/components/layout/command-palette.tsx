...
const navItems = [
  ...
  { href: "/linkedin", label: "LinkedIn", icon: MessageCircle, group: "Navigazione" },
  { href: "/telefonate", label: "Telefonate", icon: Calendar, group: "Navigazione" },
  { href: "/call-fissate", label: "Call Fissate", icon: Calendar, group: "Navigazione" },
  { href: "/trattative", label: "In Trattativa", icon: FileText, group: "Navigazione" },
